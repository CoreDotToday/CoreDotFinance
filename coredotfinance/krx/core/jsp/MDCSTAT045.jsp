...
<form action="null" class="CI-MDI-COMPONENT-WRAP" id="MDCSTAT045_FORM" method="post" name="MDCSTAT045_FORM" onsubmit="return false;">
<h2 class="tit_h2">
<p>[13103] 개별종목 시세 추이</p>
<p class="address_top">
...
<div class="search">
<p>
<input autocomplete="off" id="tboxisuCd_finder_secuprodisu1" name="tboxisuCd_finder_secuprodisu1" style="width: 350px;" title="ETF/ETN/ELW 종목 검색" type="text" value="152100/ARIRANG 200"/>
<img alt="검색팝업" id="btnisuCd_finder_secuprodisu1" name="btnisuCd_finder_secuprodisu1" src="/pub/img/btn_dbg.png"/>
</p>
</div>
</div>
<input id="isuCd_finder_secuprodisu1" name="isuCd" type="hidden" value="KR7152100004">
<input id="isuCd_finder_secuprodisu12" name="isuCd2" type="hidden" value="KR7152100004"/>
<input id="codeNmisuCd_finder_secuprodisu1" name="codeNmisuCd_finder_secuprodisu1" type="hidden" value="ARIRANG 200"/>
<input id="param1isuCd_finder_secuprodisu1" name="param1isuCd_finder_secuprodisu1" type="hidden" value=""/>
<input id="" name="" type="hidden" value=""/>
<script type="text/javascript">
  mdc.module.setModule({
    name: 'FINDER_COMPONENT_isuCd_finder_secuprodisu1',
    init: 'init',
    mdi: {
    ...
    function: function (self, api) {
      ...
      self.init = function () {
        ...
        if(cookie.finderCd === self.getCookieFinderCd()){
          ...
          if(typeNo == ('1')){
            if(cookie.codeVal)$sel('#isuCd_finder_secuprodisu1').val(cookie.codeVal);
            if(cookie.tbox)$sel('#tboxisuCd_finder_secuprodisu1').val(cookie.tbox);
            if(cookie.codeNm)$sel('#codeNmisuCd_finder_secuprodisu1').val(cookie.codeNm);
            if(cookie.codeVal2)$sel('#isuCd_finder_secuprodisu12').val(cookie.codeVal2);
      ...
      $sel('#btnisuCd_finder_secuprodisu1').on('click', function () {

        if($sel('#tboxisuCd_finder_secuprodisu1').val()==""){
      ...
      $sel('#tboxisuCd_finder_secuprodisu1').on('keydown', function (e) {
        if (13 == e.keyCode) {
          if($sel('#tboxisuCd_finder_secuprodisu1').val()==""){
            self.openFinder(false);
          }else{
      ...
      self.getCookieFinderCd = function(){
        ...
        if(curFinderCd === 'finder_secuprodisu'){
          cookieFinderCd = 'finder_secuprodisu1';
        }
        else {
      ...
      self.openFinder = function (isKeyDown) {
        ...
        //캐쉬가 false/true선택관계없이 사용자가 검색어 입력시 그 값을 종목검색 팝업창에 전달
          ...
          var cookieFinderCdVal = api.util.getCookie(cookieFinderCd+'_finderCd');
            ...
            var s_defaultVal = '152100/ARIRANG 200';
            var s_tbox = api.util.getCookie(self.getCookieFinderCd()+'_tbox');

            if(s_tbox !== $sel('#tboxisuCd_finder_secuprodisu1').val() && s_defaultVal !== $sel('#tboxisuCd_finder_secuprodisu1').val()){
              s_tboxNmVal = $sel('#tboxisuCd_finder_secuprodisu1').val();
            }

        var params = {
          finderNo: '_finder_secuprodisu1',
          finderCd: 'finder_secuprodisu',
          typeNo: '1',
          compValue: '',
          param1 : $sel('#param1isuCd_finder_secuprodisu1').val(),
          tboxId : 'tboxisuCd_finder_secuprodisu1',
          tboxNm : s_tboxNmVal,
          codeValId : 'isuCd_finder_secuprodisu1',
          codeNmId : 'codeNmisuCd_finder_secuprodisu1',
          pnlid : '',
          disableCompValue: '',
          initSearch: 'false'
        };
        ...
        if(mdc.validate.checkSearchText(params.tboxNm)){
          ...
          if ( visble && $selLi.length ) {
            $('a', $selLi).click();
                ...
                if ( $sel('#tboxisuCd_finder_secuprodisu1').val() != '' ) {
                  mdc.module.getModule('MDCSTAT045_')['getList']($sel('#tboxisuCd_finder_secuprodisu1'));
                }
          ...
          mdc.layer.openModal({
            ...
            id: 'jsLayer_finder_secuprodisu1',
            ...
            afterAppend: function () {
              api.module.getModule('FINDER_LAYER__finder_secuprodisu1').procInit();
            }
          });
        }
      };
      ...
      $sel('#tboxisuCd_finder_secuprodisu1').on('keyup', function (e) {
        if ( e.keyCode != 13 && !isEmptyCodeVal) {
          $sel('#isuCd_finder_secuprodisu1').val("");
          $sel('#isuCd_finder_secuprodisu12').val("");
          isEmptyCodeVal = true;
        }
      });
  ...
  $('#tboxisuCd_finder_secuprodisu1').autocomplete({
    'contextName' : 'finder_secuprodisu_etf',
    'bldPath' : '/dbms/comm/finder/finder_secuprodisu_etf_autocomplete',
    'viewCount' : 5,
    'submit' : function (li) {
      ...
      $('#codeNmisuCd_finder_secuprodisu1').val(li.attr('data-nm'));
      $('#isuCd_finder_secuprodisu1').val(li.attr('data-cd'));
      $('#isuCd_finder_secuprodisu12').val(li.attr('data-tp'));

      // 지수면 명칭만
      if ( 'ISU' === 'IDX' ) {
        $('#tboxisuCd_finder_secuprodisu1').val(li.attr('data-nm'));
      }
      // 회사면 발행기관 코드
      else if ( 'ISU' === 'COM' ) {
        $('#tboxisuCd_finder_secuprodisu1').val(li.attr('data-cd')+'/'+li.attr('data-nm'));
      }
      // 그외 코드/명칭
      else {
        $('#tboxisuCd_finder_secuprodisu1').val(li.attr('data-tp')+'/'+li.attr('data-nm'));
      }
...
<td>
<div class="cal-wrap"><input id="strtDd" name="strtDd" placeholder="기간 시작일" type="text" value="20210614"/><input id="endDd" name="endDd" placeholder="기간 종료일" type="text" value="20210622"/></div>
<script type="text/javascript">
  mdc.module.setModule({
    name: 'SEARCH_COMPONENT__104654608',
    mdi: {
      name: mdc.module.getMdiModuleName()
    },
    function: function (self, api) {
...
<script type="text/javascript">
  mdc.module.setModule({
    name: 'SEARCH_COMPONENT__104654609',
    mdi: {
      name: mdc.module.getMdiModuleName()
    },
    function: function (self, api) {
      ...
      var $element = $content.select('[name="search"]');
        ...
        $element.on('click', function () {
          mdc.module.getModule('MDCSTAT045_')['getList']($(this));
        });
...
<p>
<select class="CI-MDI-UNIT-SHARE" disabled="" name="share" style="display: none;"><option selected="" value="1">좌</option><option value="2">천좌</option><option value="3">백만좌</option></select>
...
<th align="right" name="CMPPREVDD_PRC" rowspan="2" scope="col" width="65px">대비</th>
<th align="right" name="FLUC_RT" rowspan="2" scope="col" width="70px">등락률</th>
<th align="right" name="LST_NAV" rowspan="2" scope="col" width="90px">순자산가치<br/>(NAV)</th>
...
<th align="right" name="MKTCAP" rowspan="2" scope="col" width="120px">시가총액</th>
<th align="right" name="INVSTASST_NETASST_TOTAMT" rowspan="2" scope="col" width="110px">순자산총액</th>
<th align="right" name="LIST_SHRS" rowspan="2" scope="col" width="85px">상장좌수</th>
<th colspan="4" name="IDX_PARENT" scope="col" width="335px">기초지수</th>
</tr>
<tr>
<th name="IDX_IND_NM" parent="IDX_PARENT" scope="col" width="120px">지수명</th>
<th align="right" name="OBJ_STKPRC_IDX" parent="IDX_PARENT" scope="col" width="80px">종가</th>
<th align="right" name="CMPPREVDD_IDX" parent="IDX_PARENT" scope="col" width="65px">대비</th>
<th align="right" name="IDX_FLUC_RT" parent="IDX_PARENT" scope="col" width="70px">등락률</th>
</tr>
</thead>
<tbody>
<tr>
...
<td bind="LST_NAV" name="LST_NAV"></td>
...
<td bind="INVSTASST_NETASST_TOTAMT" name="INVSTASST_NETASST_TOTAMT"></td>
...
<p><span class="">주</span><span><em>1.</em><dfn>지수산출기관, 정보제공기관, 거래소간 휴장일 차이 등으로 인해 기초지수 등 정보에 오류, 지연이 발생할 수 있으며 거래소는 이로 인한 투자결과에 대해 법적인 책임을 지지 않습니다. 또한 이용자는 게시된 기초지수 정보를 무단으로 배포할 수 없습니다.</dfn><em>2.</em><dfn>순자산총액은 익일 새벽에 산출되므로 전일자까지만 조회 가능합니다.</dfn></span></p>
...
<script type="text/javascript">
  mdc.module.setModule({
    ...
    function: function (self, api) {
      var $content = api.getModuleNode();
      var $f = $content.select('#MDCSTAT045_FORM');
      ...
      self.init = function () {
        self.grid = api.util.grid.init({
          ...
          grid: [
            {
              template: $content.select('#jsGrid_MDCSTAT045_0'),
              bld: 'dbms/MDC/STAT/standard/MDCSTAT04501',
              bldDataKey: 'output',
              unit: {
                share: ['ACC_TRDVOL', 'LIST_SHRS'],
                money: ['ACC_TRDVAL','MKTCAP','INVSTASST_NETASST_TOTAMT']
              },
              fluctuation: {
