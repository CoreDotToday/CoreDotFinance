...
<form action="null" class="CI-MDI-COMPONENT-WRAP" id="MDCSTAT043_FORM" method="post" name="MDCSTAT043_FORM" onsubmit="return false;">
<h2 class="tit_h2">
<p>[13101] 전종목 시세</p>
<p class="address_top">
...
<td>
<div class="cal-wrap"><input id="trdDd" name="trdDd" placeholder="기간" type="text" value="20210622"/></div>
<script type="text/javascript">
  mdc.module.setModule({
    name: 'SEARCH_COMPONENT__154917880',
    mdi: {
...
<script type="text/javascript">
  mdc.module.setModule({
    name: 'SEARCH_COMPONENT__154917882',
    mdi: {
      name: mdc.module.getMdiModuleName()
    },
    function: function (self, api) {
      ...
      var $element = $content.select('[name="search"]');
        ...
        $element.on('click', function () {
          mdc.module.getModule('MDCSTAT043_')['getList']($(this));
        });
...
<div id="jsGrid_MDCSTAT043_0">
<table>
<thead>
<tr>
<th align="center" name="ISU_SRT_CD" rowspan="2" scope="col" width="90px">종목코드</th>
<th name="ISU_ABBRV" rowspan="2" scope="col" width="190px">종목명</th>
...
<th align="right" name="NAV" rowspan="2" scope="col" width="130px">순자산가치(NAV)</th>
...
<th align="right" name="ACC_TRDVOL" rowspan="2" scope="col" width="90px">거래량</th>
...
<th align="right" name="INVSTASST_NETASST_TOTAMT" rowspan="2" scope="col" width="120px">순자산총액</th>
<th align="right" name="LIST_SHRS" rowspan="2" scope="col" width="120px">상장좌수</th>
<th colspan="4" name="IDX" scope="col" width="450px">기초지수</th>
</tr>
<tr>
<th name="IDX_IND_NM" parent="IDX" scope="col" width="190px">지수명</th>
...
<script type="text/javascript">
  mdc.module.setModule({
    ...
    function: function (self, api) {
      var $content = api.getModuleNode();
      var $f = $content.select('#MDCSTAT043_FORM');
      ...
      self.init = function () {
        self.grid = api.util.grid.init({
          ...
          grid: [
            {
              template: $content.select('#jsGrid_MDCSTAT043_0'),
