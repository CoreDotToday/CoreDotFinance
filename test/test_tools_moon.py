...
from coredotfinance.krx.tools_moon import convert_stock_name2ticker, convert_stock_ticker2name, get_stock_info, get_stock_pack, get_df_12009, get_adjusted_price
...
def test_get_df_12009():
    cols = ['거래량_기관', '거래량_기타법인', '거래량_개인', '거래량_외국인', '거래량_전체',
            '거래대금_기관', '거래대금_기타법인', '거래대금_개인', '거래대금_외국인', '거래대금_전체']
