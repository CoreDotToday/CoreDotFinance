...
class CarbonEmission(Commodity):  # 배출권 [16301~16304]
    ...
    def __init__(self, code, start, end, day, **kwargs):
        ...
        super(CarbonEmission, self).__init__(code, start, end, day, code_to_function, kwargs)
        self.kwargs = kwargs
        self.item = self.kwargs.get('item', None)  # isuCd: 개별종목명 [예: KRD050022007(KAU20), KRD050032105(KAU21)]
