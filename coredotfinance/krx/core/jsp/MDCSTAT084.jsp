...
<form action="null" class="CI-MDI-COMPONENT-WRAP" id="MDCSTAT084_FORM" method="post" name="MDCSTAT084_FORM" onsubmit="return false;">
<h2 class="tit_h2">
<p>[13302] 개별종목 시세 추이</p>
<p class="address_top">
...
<div class="search">
<p>
<input autocomplete="off" id="tboxisuCd_finder_secuprodisu3" name="tboxisuCd_finder_secuprodisu3" style="width: 350px;" title="ETF/ETN/ELW 종목 검색" type="text" value=""/>
<img alt="검색팝업" id="btnisuCd_finder_secuprodisu3" name="btnisuCd_finder_secuprodisu3" src="/pub/img/btn_dbg.png"/>
</p>
</div>
</div>
<input id="isuCd_finder_secuprodisu3" name="isuCd" type="hidden" value="">
<input id="isuCd_finder_secuprodisu32" name="isuCd2" type="hidden" value=""/>
<input id="codeNmisuCd_finder_secuprodisu3" name="codeNmisuCd_finder_secuprodisu3" type="hidden" value=""/>
<input id="param1isuCd_finder_secuprodisu3" name="param1isuCd_finder_secuprodisu3" type="hidden" value=""/>
<input id="" name="" type="hidden" value=""/>
<script type="text/javascript">
  mdc.module.setModule({
    name: 'FINDER_COMPONENT_isuCd_finder_secuprodisu3',
    init: 'init',
    mdi: {
    ...
    function: function (self, api) {
      ...
      self.init = function () {
        ...
        if(cookie.finderCd === self.getCookieFinderCd()){
          ...
          if(typeNo == ('3')){
            if(cookie.codeVal)$sel('#isuCd_finder_secuprodisu3').val(cookie.codeVal);
            if(cookie.tbox)$sel('#tboxisuCd_finder_secuprodisu3').val(cookie.tbox);
            if(cookie.codeNm)$sel('#codeNmisuCd_finder_secuprodisu3').val(cookie.codeNm);
            if(cookie.codeVal2)$sel('#isuCd_finder_secuprodisu32').val(cookie.codeVal2);
      ...
      $sel('#btnisuCd_finder_secuprodisu3').on('click', function () {

        if($sel('#tboxisuCd_finder_secuprodisu3').val()==""){
      ...
      $sel('#tboxisuCd_finder_secuprodisu3').on('keydown', function (e) {
        if (13 == e.keyCode) {
          if($sel('#tboxisuCd_finder_secuprodisu3').val()==""){
            self.openFinder(false);
          }else{
      ...
      self.getCookieFinderCd = function(){
        ...
        if(curFinderCd === 'finder_secuprodisu'){
          cookieFinderCd = 'finder_secuprodisu3';
        }
        else {
      ...
      self.openFinder = function (isKeyDown) {
        ...
        //캐쉬가 false/true선택관계없이 사용자가 검색어 입력시 그 값을 종목검색 팝업창에 전달
          ...
          var cookieFinderCdVal = api.util.getCookie(cookieFinderCd+'_finderCd');
            ...
            if(s_tbox !== $sel('#tboxisuCd_finder_secuprodisu3').val() && s_defaultVal !== $sel('#tboxisuCd_finder_secuprodisu3').val()){
              s_tboxNmVal = $sel('#tboxisuCd_finder_secuprodisu3').val();
            }

        var params = {
          finderNo: '_finder_secuprodisu3',
          finderCd: 'finder_secuprodisu',
          typeNo: '3',
          compValue: '',
          param1 : $sel('#param1isuCd_finder_secuprodisu3').val(),
          tboxId : 'tboxisuCd_finder_secuprodisu3',
          tboxNm : s_tboxNmVal,
          codeValId : 'isuCd_finder_secuprodisu3',
          codeNmId : 'codeNmisuCd_finder_secuprodisu3',
          pnlid : '',
          disableCompValue: '',
          initSearch: 'false'
        };
        ...
        if(mdc.validate.checkSearchText(params.tboxNm)){
          ...
          if ( visble && $selLi.length ) {
            $('a', $selLi).click();
                ...
                if ( $sel('#tboxisuCd_finder_secuprodisu3').val() != '' ) {
                  mdc.module.getModule('MDCSTAT084_')['getList']($sel('#tboxisuCd_finder_secuprodisu3'));
                }
          ...
          mdc.layer.openModal({
            ...
            id: 'jsLayer_finder_secuprodisu3',
            ...
            afterAppend: function () {
              api.module.getModule('FINDER_LAYER__finder_secuprodisu3').procInit();
            }
          });
        }
      };
      ...
      $sel('#tboxisuCd_finder_secuprodisu3').on('keyup', function (e) {
        if ( e.keyCode != 13 && !isEmptyCodeVal) {
          $sel('#isuCd_finder_secuprodisu3').val("");
          $sel('#isuCd_finder_secuprodisu32').val("");
          isEmptyCodeVal = true;
        }
      });
  ...
  $('#tboxisuCd_finder_secuprodisu3').autocomplete({
    'contextName' : 'finder_secuprodisu_elw',
    'bldPath' : '/dbms/comm/finder/finder_secuprodisu_elw_autocomplete',
    'viewCount' : 5,
    'submit' : function (li) {
      ...
      $('#codeNmisuCd_finder_secuprodisu3').val(li.attr('data-nm'));
      $('#isuCd_finder_secuprodisu3').val(li.attr('data-cd'));
      $('#isuCd_finder_secuprodisu32').val(li.attr('data-tp'));

      // 지수면 명칭만
      if ( 'ISU' === 'IDX' ) {
        $('#tboxisuCd_finder_secuprodisu3').val(li.attr('data-nm'));
      }
      // 회사면 발행기관 코드
      else if ( 'ISU' === 'COM' ) {
        $('#tboxisuCd_finder_secuprodisu3').val(li.attr('data-cd')+'/'+li.attr('data-nm'));
      }
      // 그외 코드/명칭
      else {
        $('#tboxisuCd_finder_secuprodisu3').val(li.attr('data-tp')+'/'+li.attr('data-nm'));
      }
...
<script type="text/javascript">
  mdc.module.setModule({
    name: 'SEARCH_COMPONENT__091756386',
    mdi: {
      name: mdc.module.getMdiModuleName()
    },
    function: function (self, api) {
...
<script type="text/javascript">
  mdc.module.setModule({
    name: 'SEARCH_COMPONENT__091756390',
    mdi: {
      name: mdc.module.getMdiModuleName()
    },
    function: function (self, api) {
      ...
      var $element = $content.select('[name="search"]');
        ...
        $element.on('click', function () {
          mdc.module.getModule('MDCSTAT084_')['getList']($(this));
        });
...
<div id="jsGrid_MDCSTAT084_0">
<table>
<thead>
<tr>
<th align="center" name="TRD_DD" rowspan="2" scope="col" width="100px">일자</th>
<th align="right" name="TDD_CLSPRC" rowspan="2" scope="col" width="90px">종가</th>
<th align="right" name="CMPPREVDD_PRC" rowspan="2" scope="col" width="90px">대비</th>
<th align="right" name="TDD_OPNPRC" rowspan="2" scope="col" width="90px">시가</th>
<th align="right" name="TDD_HGPRC" rowspan="2" scope="col" width="90px">고가</th>
<th align="right" name="TDD_LWPRC" rowspan="2" scope="col" width="90px">저가</th>
<th align="right" name="ACC_TRDVOL" rowspan="2" scope="col" width="120px">거래량</th>
...
<th align="right" name="LIST_SHRS" rowspan="2" scope="col" width="130px">상장증권수</th>
<th align="right" colspan="4" name="ULY_PARENT" scope="col" width="390px">기초자산</th>
</tr>
<tr>
<th name="ULY_NM" parent="ULY_PARENT" scope="col" width="120px">자산명</th>
<th align="right" name="ULY_CLSPRC" parent="ULY_PARENT" scope="col" width="90px">종가</th>
<th align="right" name="CMPPREVDD_PRC1" parent="ULY_PARENT" scope="col" width="90px">대비</th>
<th align="right" name="FLUC_RT" parent="ULY_PARENT" scope="col" width="90px">등락률</th>
</tr>
</thead>
<tbody>
<tr>
...
<td bind="ULY_CLSPRC" name="ULY_CLSPRC"></td>
...
<script type="text/javascript">
  mdc.module.setModule({
    ...
    function: function (self, api) {
      var $content = api.getModuleNode();
      var $f = $content.select('#MDCSTAT084_FORM');
      ...
      self.init = function () {
        self.grid = api.util.grid.init({
          ...
          grid: [
            {
              template: $content.select('#jsGrid_MDCSTAT084_0'),
