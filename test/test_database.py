...
def test_krx_read():
    dataframe = krx.read(symbol='000660', start='2021-07-20', end='2021-07-20', api=True)
...
def test_krx_stock_adjust():
    dataframe = krx.read('035720', start='2021-04-14', end='2021-04-15', adjust=True, api=True)
