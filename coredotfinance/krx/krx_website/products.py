...
class Product(Info):
    def __init__(
        self, code, start, end, day, item, item_type, code_to_function, **kwargs
    ):
        """
        증권상품
        :param code:
...
class ETF(Product):
    def __init__(self, code, start, end, day, product, **kwargs):
        ...
        super(ETF, self).__init__(
            code, start, end, day, product, "ETF", code_to_function, **kwargs
        )
...
class ETN(Product):
    def __init__(self, code, start, end, day, product, **kwargs):
        ...
        super(ETN, self).__init__(
            code, start, end, day, product, "ETN", code_to_function, **kwargs
        )
...
class ELW(Product):
    def __init__(self, code, start, end, day, product, **kwargs):
        ...
        super(ELW, self).__init__(
            code, start, end, day, product, "ELW", code_to_function, **kwargs
        )
        self.basic_asset = kwargs.get("basic_asset", None)

    def price_of_entire_items(self):
        """전종목 시세[13301]"""
        data = {"bld": "dbms/MDC/STAT/standard/MDCSTAT08301", "trdDd": self.day}
        return self.update_requested_data(data)
    ...
    def approach_level_of_early_close(self):
        """조기종료 접근[13309]"""
        data = {"bld": "dbms/MDC/STAT/standard/MDCSTAT09201", "trdDd": self.day}
        return self.update_requested_data(data)
